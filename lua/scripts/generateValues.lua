...
local widgetButton = {
    ...
    text_label_unicode_strings_list = [[[shm]\halo_4\ui\shell\pause_game\forge_settings_menu\strings\values.unicode_string_list]],
...
for buttonIndex = 1, tonumber(args.buttonsQuantity) do
    ...
    createButton = createButton:gsub("{realButtonIndex}", buttonIndex - 1)
